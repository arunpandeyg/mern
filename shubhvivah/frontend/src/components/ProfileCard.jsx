    ...
    <div className="flex justify-center items-center w-full h-[478px]">
      <div className="bg-white p-6 rounded-lg shadow-lg w-96">
        ...
        <img
          ...
          alt="Profile"
        />
        <p className="text-gray-800 text-lg font-semibold mb-2">FullName</p>
        <p className="text-gray-600 mb-4">Software Engineer</p>
        <p className="text-gray-700 mb-4">Income: $100,000</p>
        <p className="text-gray-700 mb-4">Category: Technology</p>
        <p className="text-gray-700 mb-4">PhoneNumber: phoneNumber</p>
