...
const About = () => {
  return (
    <div>
      ...
      <p className="text-gray-700 text-lg leading-relaxed max-w-2xl mx-auto my-6 text-justify">
        {" "}
        Welcome to <span className="text-blue-600 font-semibold ">MyStories</span>,
